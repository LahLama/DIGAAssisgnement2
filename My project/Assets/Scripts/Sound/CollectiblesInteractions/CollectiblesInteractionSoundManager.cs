...
public class CollectiblesInteractionSoundManager : MonoBehaviour     //here
{
    /*
    ...
    */
    private static CollectiblesInteractionSoundManager instance;          //here
    private static AudioSource audioSource; // Reference to the AudioSource component
    private static CollectiblesInteractionSoundLibrary collectiblesInteractionSoundLibrary; // Reference to the SoundEffectLibrary script       //here
    ...
    private void Awake()
    {
        ...
        if (instance == null)
        {
            ...
            collectiblesInteractionSoundLibrary = GetComponent<CollectiblesInteractionSoundLibrary>(); // Get the SoundEffectLibrary component attached to this GameObject      //here
        }
    ...
    {
        AudioClip audioClip = collectiblesInteractionSoundLibrary.GetRandomClip(soundName); // Get a random audio clip from the SoundEffectLibrary            //here
        if (audioClip != null)
        {
